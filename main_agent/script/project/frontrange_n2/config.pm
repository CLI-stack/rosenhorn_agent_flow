...
%clk_name =(cit_usr=>FCLK,vcn=>VCN_DCLK,vcn_m_0_t=>"VCN_VCLK VCN_DCLK",mmhub=>SOCCLK,nbio=>NBIO_LCLK,secip=>SOCCLK,umc=>"UMC_UCLK");

#cts tree latency limit
 $max_clk_latency = 230;
 $clk_gskew_red =35;
 #$main_clk_corner = "tt0p9v100c_typrc100c";
 $main_clk_corner = "tt0p6v0c_typrc100c_setup";
 $main_rpt_corner = "FuncTT0p6v";

#config setup corner extact for FX target
#@main_corner_l =qw/tt0p9v100c_typrc100c_FuncTT0p9v tt0p65v0c_typrc100c_FuncTT0p65v/;
@main_corner_l =qw/typrc100c_FuncTT0p6v typrc100c_FuncTT0p65v/;
#F2F grp : 1 only check main clk ;0: total clks exclude async_default
$f2f_mainclk =0;

#config timing wall corner 
%twall_pt=(PtTimFuncTT0p6vReRouteTyprc100cTT0P6V0CStp=>"FCLK UCLK VCN_DCLK VCN_VCLK UMC_UCLK",PtTimFuncTT0p6vReRouteTyprc100cTT0P6V0CStp=>default);
  
 ###noSI PT
 @PtFuncSetup = qw/PtTimFuncTT0p6vReRouteTyprc100cTT0P6V0CStp PtTimFuncStpFFG1p05vReRouteTyprc100cFFGNP1P05VM40CStp PtTimFuncStpSSG0p6vReRouteTyprc100cSSGNP0P6VM40CStp/;
 #@PtFuncHld = qw/PtTimFuncHldFFG1p05vReRouteSiRcbestCCbest0cFFG1P05V0CHld PtTimFuncHldFFG1p05vReRouteSiRcworstCCworst100cFFG1P05V0CHld PtTimFuncHldSSG0p6vReRouteSiRcbestCCbest0cSSG0P6V0CHld PtTimFuncHldSSG0p6vReRouteSiRcworstCCworst100cSSG0P6V0CHld/;
 ...
 #SI PT
 @PtFuncSetup_SI = qw/PtTimFuncTT0p6vReRouteSxTyprc100cTT0P6V0CStp PtTimFuncTT0p65vReRouteSxTyprc100cTT0P65VM40CStp PtTimFuncTT0p6vReRouteSxTyprc100cTT0P6VM40CStp PtTimFuncStpFFG1p05vReRouteSxTyprc100cFFGNP1P05VM40CStp PtTimFuncStpSSG0p6vReRouteSxTyprc100cSSGNP0P6VM40CStp/;
