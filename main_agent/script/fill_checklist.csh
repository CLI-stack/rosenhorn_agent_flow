...
#list#
    The checklist has been filled:
#table#
EOF
set checklist_script = `python3 $source_dir/script/read_csv.py --csv $source_dir/assignment.csv | grep "checklist,"  | awk -F "," '{print $2}' | sed 's/\r//g'`
...
foreach rd (`echo $eff_rd`)
    ...
    echo "$t,$rd,checklist filled" >> $source_dir/data/${tag}_spec
end
