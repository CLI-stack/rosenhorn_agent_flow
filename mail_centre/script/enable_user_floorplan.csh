...
#list#
    User floorplan has been enabled:
#table#
EOF
...
set task = "pre_enable_user_floorplan_TileBuilderGenParams"
set task_file = ${task}_$tag
foreach rd (`echo $eff_rd`)
    cd $rd
    echo "# Start to enable user floorplan."
    echo "I2_MLPLACE_MACROS = 0" >> override.params
    chmod 744 tune/FxFpPlaceMacros/FxFpPlaceMacros.preplace.tcl
    echo "source /tools/aticad/1.0/src/zoo/PD_agent/tile/debug/enable_user_floorplan.tcl" >> tune/FxFpPlaceMacros/FxFpPlaceMacros.preplace.tcl 
    TileBuilderTerm -x "TileBuilderGenParams;TileBuilderOverwriteCommand cmds/FxFpPlaceMacros.cmd;touch $task_file"
end
