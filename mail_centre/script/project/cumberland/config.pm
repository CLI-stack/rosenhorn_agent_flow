...
%clk_name =(cit_usr=>FCLK,vcn=>VCN_DCLK,vcn_m_0_t=>"VCN_VCLK VCN_DCLK",mmhub=>SOCCLK,nbio=>NBIO_LCLK,secip=>SOCCLK,ucake=>MID_UCIELCLK);
...
%twall_pt=(PtTimFuncTT0p65vRouteTyprc100cTT0P65V0CStp=>"FCLK UCLK VCN_DCLK VCN_VCLK MID_UCIELCLK",PtTimFuncTT0p9vReRouteTyprc100cTT0P9V100CStp=>default);
  
 ###noSI PT
 @PtFuncSetup = qw/PtTimFuncTT0p9vReRouteTyprc100cTT0P9V100CStp PtTimFuncTT0p65vRouteTyprc100cTT0P65V0CStp PtTimFuncTT0p6vReRouteTyprc100cTT0P6VM40CStp PtTimFuncStpFFG1p05vReRouteTyprc100cFFGNP1P05VM40CStp PtTimFuncStpSSG0p6vReRouteTyprc100cSSGNP0P6VM40CStp/;
