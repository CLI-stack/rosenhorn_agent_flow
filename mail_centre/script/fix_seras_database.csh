...
#list#
    TileBuilderFixSerasDatabase has been run:
#table#
EOF
...
foreach rd (`echo $eff_rd`)
    ...
    echo "$t,$rd,TileBuilderFixSerasDatabase passed" >> $source_dir/data/${tag}_spec
end
